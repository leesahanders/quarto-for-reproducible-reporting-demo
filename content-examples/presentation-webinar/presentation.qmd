...
format:
  positslides-revealjs: 
    ...
    filters:
      - positslides
    footer: <a href="https://github.com/leesahanders/quarto-for-reproducible-reporting-demo/tree/main/content-examples/presentation-webinar">quarto-for-reproducible-reporting-demo/tree/main/content-examples/presentation-webinar</a>
revealjs-plugins:
  - confetti
---
